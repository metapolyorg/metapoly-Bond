...
contract DvDRedeemerTestnet is Initializable, OwnableUpgradeable {
    ...
    function initialize(IERC20 _dvd, IERC20 _vipDvd, IERC20 _pd33d,
        ...
        uint[] memory _amountVipDVD, uint[] memory _intervalVipDvd, uint[] memory _priceVipDvd, address _trustedForwarderAddress) external initializer {
        DVD = _dvd;
        VIPDVD = _vipDvd;
        pD33D = _pd33d;
    ...
    function redeemDVD(uint _dvdAmount) external {
        ...
        DVD.burnFrom(_sender, _dvdAmount);
