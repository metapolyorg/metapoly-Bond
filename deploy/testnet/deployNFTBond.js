...
module.exports = async () => {
    ...
    // await upgrades.upgradeProxy(addresses.bond.LAND_Bond, BondContract)
    
    let bondContract = await upgrades.deployProxy(BondContract, [addresses.d33d, addresses.NFT.LAND, addresses.treasury, 
        ethers.constants.AddressZero, addresses.stakingFlexible, addresses.address.DAO, deployer.address, PriceUpdater.address
        ])
  ...
  module.exports.tags = ["testnet_deploy_nftBond"]
