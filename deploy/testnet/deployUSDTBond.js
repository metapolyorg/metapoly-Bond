...
module.exports = async () => {
    ...
    let bondContract = await upgrades.deployProxy(BondContract, [addresses.d33d, addresses.tokens.usdt, addresses.treasury, 
    ...
    console.log("USDT BOND Proxy: ", bondContract.address)
  
  };
  
  
  
  module.exports.tags = ["testnet_deploy_bond_usdt"]
